...
export async function POST(req: NextRequest) {
  try {
    ...
    const updatedStoryData = {
      ...
      value: storyGenerated.value,
      bibleReference: storyGenerated.bibleReference,
      mission: storyGenerated.mission,
      reflection: storyGenerated.reflection,
      coverEmoji: storyGenerated.coverEmoji,
