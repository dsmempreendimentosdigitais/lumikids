...
const email = 'adminkids@lumikids.app';
const password = 'admin123';
const displayName = 'Admin Kids';
...
async function run() {
  ...
  // Create Firestore document with Premium access and Admin role
  ...
  console.log('Documento Firestore configurado com plano PREMIUM2 e status de ADMIN (acesso total)!');
  process.exit(0);
}
